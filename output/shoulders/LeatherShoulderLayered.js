...
const LeatherShoulderLayered = ({ color = [] }) => {
  return (
    <g id="LeatherShoulderLayered">
      <g opacity="0.2">
        <path d="M36.7,62.7c-1.4-2.9-4.4-4.6-4.4-4.6l-0.1-0.9c0.5-0.5,1-1,1.6-1.4c-0.2-0.2-0.4-0.4-0.4-0.4l0.1-0.9 c1.3-0.7,2.7-1.3,4.3-1.7c-0.1-0.3-0.2-0.4-0.2-0.4l0.3-0.8c1.4-0.6,2.9-0.9,4.6-0.9c3.2,0,5.7,1,5.8,1.1l0.3,0.7l-1.6,6.4 c0.3,0.4,0.4,0.8,0.4,1.3l0,0c0,0.1,0,0.2,0,0.2c0,0.8-0.4,1.5-1.1,1.9l0,0c-0.2,0.3-0.6,0.3-0.9,0.3c0,0,0,0,0,0 c-0.5,0-1.2-0.1-2.3-0.3c-0.6,0.1-1.3,0.2-2.1,0.2c-0.3,0-0.7,0-1,0L37.3,63L36.7,62.7z" />
      ...
      <g>
        ...
        <radialGradient
          ...
          cy="60.22"
          r="1.702"
          gradientTransform="matrix(-1 0 0 1 80.865 0)"
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0" stopColor="#fff" />
          <stop offset="0.662" stopColor="#8b5e3c" />
